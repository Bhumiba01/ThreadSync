    ...
    <>
      ...
      {currentPost.img && (
        ...
        <Flex justifyContent={"space-between"}>
          ...
          <Text color={"gray.light"}>Get the app to like, reply the post.</Text>
          </Flex>
          <Button>
            Get
          </Button>
        ...
        {currentPost.replies.map(reply => (
          <Comment key={reply._id} reply={reply} lastReply={reply.id === currentPost.replies[currentPost.replies.length - 1]._id}/>
        ))}
